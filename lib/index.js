...
var Luxafor = function () {
  ...
  _createClass(Luxafor, [{
    ...
    key: 'setColor',
    value: function setColor(color, side, command) {
      var rgb = _colorMap2.default[color.toLowerCase()];
      this.write({ command: command, side: side, r: rgb.r, g: rgb.g, b: rgb.b });
      return this;
    }
    ...
    key: 'strobeColor',
    value: function strobeColor(r, g, b, speed, repeat) {
      var side = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 'both';

      this.write({ command: 'strobe', side: side, r: r, g: g, b: b, speed: speed, repeat: repeat });
      return this;
    }
    ...
    key: 'waveColor',
    value: function waveColor(r, g, b, speed, repeat) {
      var side = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 'both';

      this.write({ command: 'wave', side: side, r: r, g: g, b: b, speed: speed, repeat: repeat });
      return this;
    }
  }]);
